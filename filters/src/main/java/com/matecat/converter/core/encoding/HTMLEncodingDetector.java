 ...
 *
 * If the HTML file contains specific charset information, it overwrites other
 * charset information found before.
 *
...
public class HTMLEncodingDetector implements IEncodingDetector {
     ...
     *
     * @param file File
     * @param suspectedEncoding Encoding we think the file can had, used to read
     * it and parse it
     * @return Encoding
     */
